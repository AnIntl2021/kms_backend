...
export const createBranch = async (req, res) => {
    try {
        ...
        const [result] = await pool.execute('INSERT INTO branches (name_en, name_ar, location_en, location_ar, phone) VALUES (?, ?, ?, ?, ?)', [name_en, name_ar, location_en || null, location_ar || null, phone || null]);
