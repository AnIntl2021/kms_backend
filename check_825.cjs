...
async function run() {
  ...
  try {
    ...
    rows.forEach(r => {
      ...
      if (dDate >= '2026-05-01' && dDate <= '2026-05-30') { // Let's check up to May 30th first
        // Let's filter by the main branches
    ...
    console.log(`TOTAL SANDWICHES IN MAY 30TH FOR THOSE 5 BRANCHES: ${totalItems}`);
